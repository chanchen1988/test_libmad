...
int mad_header_decode(struct mad_header *header, struct mad_stream *stream)
{
  ...
  if (ptr == 0) {
    ...
    //printf("mad_header_decode failed 1 \n");
    goto fail;
  }
  ...
  if (stream->skiplen) {
    ...
    if (end - ptr < stream->skiplen) {
      ...
      //printf("mad_header_decode failed 2 \n");
      goto fail;
    }
 ...
 sync:
  ...
  if (stream->sync) {
    if (end - ptr < MAD_BUFFER_GUARD) {
      ...
      stream->error = MAD_ERROR_BUFLEN;
        //printf("mad_header_decode failed 3 \n");
      goto fail;
    }
      ...
      stream->error = MAD_ERROR_LOSTSYNC;
      //printf("mad_header_decode failed 4 \n");
      goto fail;
    }
  }
  else {
	...
	stream->next_frame = end - MAD_BUFFER_GUARD;
      ...
      stream->error = MAD_ERROR_BUFLEN;
      //printf("mad_header_decode failed 5 \n");
      goto fail;
    }
  ...
  {
    //printf("mad_header_decode failed 6 \n");
    goto fail;
  }
  ...
  if (header->bitrate == 0) {
    ...
    {
      //printf("mad_header_decode failed 7 \n");  
      goto fail;
    }
  ...
  if (N + MAD_BUFFER_GUARD > end - stream->this_frame) {
    ...
    stream->error = MAD_ERROR_BUFLEN;
    //printf("mad_header_decode failed 8 \n");
    goto fail;
  }
...
int mad_frame_decode(struct mad_frame *frame, struct mad_stream *stream)
{
      ...
      mad_header_decode(&frame->header, stream) == -1)
  {
    ...
    //printf("mad_frame_decode failed 1 \n");
    goto fail;
  }
  /* audio_data() */
  ...
  if (decoder_table[frame->header.layer - 1](stream, frame) == -1) {
    ...
    //printf("mad_frame_decode failed 2\n");
    goto fail;
  }

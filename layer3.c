...
int mad_layer_III(struct mad_stream *stream, struct mad_frame *frame)
{
  ...
  printf("[mad_layer_III] md_len: %d, stream->md_len: %d, si.main_data_begin: %d, frame_space: %d, next_md_begin: %d\n", md_len, stream->md_len, si.main_data_begin, frame_space, next_md_begin);
  frame_used = 0;
...
# endif
  ...
  //printf("[mad_layer_III] md_len: %d, si.main_data_begin: %d, frame_space: %d, next_md_begin: %d\n", md_len, si.main_data_begin, frame_space, next_md_begin);
  printf("[mad_layer_III] frame_free: %d, frame_used: %d, next_md_begin: %d\n", frame_free, frame_used, next_md_begin);    
